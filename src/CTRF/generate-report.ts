/**
 * jest-ctrf-json-report (used as is see https://github.com/ctrf-io/jest-ctrf-json-reporter/tree/main)
 * is testable for non-regression by ../../test/CTRF/generate-report.test.ts
 * in case of library update.
 */
import {
  type TestResult,
  type Test,
